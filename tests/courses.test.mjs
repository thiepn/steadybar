...
test('backup v3 round trip retains learning and rejects tampered known-revision passes',()=>{
 ...
 const b=createBackup(data);assert.equal(b.version,3);assert.deepEqual(parseBackup(JSON.stringify(b)).data,{...data,trainingPlans:[],weeklySchedules:[],recordings:[],timingResults:[],midiDeviceProfiles:[],midiResults:[],audioTracks:[]});
