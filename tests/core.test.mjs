...
test('backup rejects unknown format or future version',()=>{const b=createBackup(seedData());assert.throws(()=>v.validateBackup({...b,format:'other'}),/not a Steadybar/);assert.throws(()=>v.validateBackup({...b,version:3}),/unsupported/);});
