...
export function pageHeader(eyebrow, title, description, actions = []) {
    return el('header', { class: 'page-heading' }, el('div', { class: 'page-heading-text' }, eyebrow ? el('div', { class: 'eyebrow' }, eyebrow) : null, el('h1', {}, title), description ? el('p', {}, description) : null), actions.length ? el('div', { class: 'actions' }, actions) : null);
}
...
export function empty(title, description, action, _symbol = 'routine') {
