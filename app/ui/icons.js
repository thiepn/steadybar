...
export function icon(name, size = 19) { return svg('svg', { viewBox: '0 0 24 24', width: size, height: size, fill: 'none', stroke: 'currentColor', 'stroke-width': 1.7, 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'aria-hidden': 'true' }, svg('path', { d: paths[name] })); }
export function brandMark() { return svg('svg', { viewBox: '0 0 32 32', width: 32, height: 32, 'aria-hidden': 'true' }, svg('rect', { width: 32, height: 32, rx: 7, fill: 'var(--brand-bg)' }), svg('path', { d: 'M8 18v-4 M13 22V10 M19 20v-8 M24 17v-2', stroke: 'var(--brand-ink)', 'stroke-width': 2.5, 'stroke-linecap': 'round' })); }
