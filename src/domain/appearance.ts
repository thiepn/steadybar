/** Persisted IDs are stable; this catalog is also used to generate CSS and first-paint hints. */
export const PALETTES = [
  ...
  },
  {
    ...
    "light": {
      ...
      "surface": "#ffffff",
      "surface-soft": "#eaf0f5",
      "surface-hover": "#e0e8f0",
      "border": "#d3dce6",
      "border-strong": "#6a7787"
    },
    "dark": {
      "bg": "#11151b",
      "surface": "#1a2029",
      "surface-soft": "#232d3a",
      "surface-hover": "#2c3848",
      "border": "#3c4858",
      "border-strong": "#96a4b5"
    }
  },
  {
    "id": "midnight",
    ...
    "light": {
      ...
      "surface": "#ffffff",
      "surface-soft": "#e7eefb",
      "surface-hover": "#dce6f7",
      "border": "#d0dcf0",
      "border-strong": "#67768e"
    },
    "dark": {
      "bg": "#0c1220",
      "surface": "#141e30",
      "surface-soft": "#1d2a40",
      "surface-hover": "#26364f",
      "border": "#354660",
      "border-strong": "#95a8c4"
    }
  },
  {
    "id": "dusk",
    "label": "Dusk",
    "description": "Soft indigo",
    "light": {
      "bg": "#f5f3fa",
      "surface": "#ffffff",
      "surface-soft": "#ece9f7",
      "surface-hover": "#e5e0f1",
      "border": "#dcd5e8",
      "border-strong": "#756c86"
    },
    "dark": {
      "bg": "#141222",
      "surface": "#1e1b30",
      "surface-soft": "#2a263e",
      "surface-hover": "#36314d",
      "border": "#4b425e",
      "border-strong": "#aa9fc1"
    }
  },
  {
    "id": "aubergine",
    ...
    "light": {
      ...
      "surface": "#ffffff",
      "surface-soft": "#f2e8ef",
      "surface-hover": "#eadde7",
      "border": "#dfd1dd",
      "border-strong": "#806a7e"
    },
    "dark": {
      "bg": "#1b1119",
      "surface": "#281b24",
      "surface-soft": "#362731",
      "surface-hover": "#43323d",
      "border": "#59434f",
      "border-strong": "#bda4b3"
    }
  },
  {
    "id": "coffee",
    ...
    "light": {
      ...
      "surface": "#fffdf9",
      "surface-soft": "#efebe4",
      "surface-hover": "#e6dfd6",
      "border": "#dbd3c9",
      "border-strong": "#786d5e"
    },
    "dark": {
      "bg": "#181411",
      "surface": "#241e19",
      "surface-soft": "#302821",
      "surface-hover": "#3b322a",
      "border": "#50463b",
      "border-strong": "#b2a491"
    }
  },
  {
    "id": "sand",
    ...
    "light": {
      ...
      "surface": "#fffdf6",
      "surface-soft": "#f1eddf",
      "surface-hover": "#e9e2d2",
      "border": "#dfd5c0",
      "border-strong": "#796e56"
    },
    "dark": {
      "bg": "#191710",
      "surface": "#25221a",
      "surface-soft": "#312d23",
      "surface-hover": "#3d372b",
      "border": "#524b3d",
