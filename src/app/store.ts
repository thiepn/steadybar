...
import { all, initializeDatabase, put, readData, remove, type StoreName, type StoreTypes } from '../db/database.js';
...
export class AppStore {
  ...
  async settings(change:Partial<Settings>,notify=true):Promise<void>{await this.save('settings',{...this.snapshot().settings,...change},notify);}
