...
export function openSearch():void{
  ...
  const items:SearchItem[]=[
    {label:'Start practice',type:'Command',icon:'play',action:()=>navigate('/practice')},{label:'Open metronome',type:'Command',icon:'pulse',action:()=>navigate('/metronome')},{label:'Open Timing Lab',type:'Command',icon:'pulse',action:()=>navigate('/timing-lab')},
