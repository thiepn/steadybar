...
export function drumGridPage():Page{
  ...
  const page=el('div',{class:'page drum-grid-page'},pageHeader('Drum coordination workstation','Drum Grid Lab',profile.name+' · Generate, edit, displace, mirror, preview, save, and practice coordination grids.',[
    link('Rudiment Lab','/rudiments','button secondary','routine'),link('Dynamics Lab','/dynamics','button secondary','routine'),link('Phrase Lab','/phrases','button secondary','routine'),link('MIDI Drum Lab','/midi-lab','button secondary','pulse'),link('Timing Lab','/timing-lab','button secondary','pulse'),
  ]));
