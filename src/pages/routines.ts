...
export function routinesPage():Page{
  ...
  const draw=()=>{
    ...
    if(!routines.length)list.append(empty(show?'No archived routines.':'Build a repeatable practice.','Save the sequence that works for you and use it again tomorrow.',button('New routine',()=>editRoutine(),'primary','plus')));
