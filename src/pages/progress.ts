...
export function progressPage():Page{
  ...
  const draw=()=>{
    ...
    comparison.append(el('div',{class:'diagnostic-comparison-grid'},
      ...
      comparisonCard('Solid share',resultSummary(diagnostics.comparison.current.evaluations),diagnostics.comparison.previous?resultSummary(diagnostics.comparison.previous.evaluations):undefined,diagnostics.comparison.solidShareTrend),
